...
export function AuditReport() {
  ...
  if (isLoadingAudit) {
    return <LoadingFrame>Loading audit...</LoadingFrame>;
  }
  ...
  if (audit?.status !== "FINISHED") {
    return <LoadingFrame>Running audit...</LoadingFrame>;
  }
    ...
    return (
      <div className="col-lg">
        ...
        <Button
          ...
          isPending={runAuditMutation.isPending}
          className="w-full"
        >
          Run
        </Button>
    ...
    <section className="col-lg px-15 w-[650px]">
      <div className="flex justify-between pb-15">
        <div className="col">
          ...
          <a
            target="_blank"
            href={`https://semrush.com/siteaudit/campaign/${id}/review/#overview`}
          >
            View in Semrush
          </a>
        </div>
      ...
      <div className="flex gap-8">
        ...
        <div className="flex flex-col gap-8">
          <p>Errors</p>
          <h1 className="text-2xl font-bold text-framer-red">
            {errors.length}
          </h1>
        </div>
        <div className="flex flex-col gap-8">
          <p>Warnings</p>
          <h1 className="text-2xl font-bold text-framer-yellow">
            {warnings.length}
          </h1>
        </div>
        <div className="flex flex-col gap-8">
          <p>Notices</p>
          <h1 className="text-2xl font-bold text-framer-blue">
            {notices.length}
          </h1>
        </div>
      </div>
