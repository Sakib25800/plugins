...
const semrushClientInstance = new SemrushClient({
  defaultAuditSettings: {
    ...
    excludedChecks: [
      4, 9, 10, 16, 17, 18, 27, 28, 43, 27, 29, 41, 131, 132, 133, 134, 145,
      127,
    ],
  },
});
...
// Example: 2500 -> '2.5k'
function formatNumWithMetricPrefix(n: number) {
...
const transformKeywordRow = (
  cell: Awaited<ReturnType<typeof semrush.getKeyphrases>>[0],
) => ({
...
export function useInfiniteKeywordSearchQuery(
  args: Omit<Parameters<typeof semrush.getKeyphrases>[0], "offset">,
) {
