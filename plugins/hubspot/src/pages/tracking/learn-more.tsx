...
export function LearnMoreTrackingPage() {
  return (
    <div className="col-lg">
      <p>
        The HubSpot tracking code is unique to each HubSpot account and allows
        HubSpot to monitor your website traffic, identify visitors, track
        events, CTAs and more. <br />
